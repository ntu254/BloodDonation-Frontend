...
const AdminUserEditPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Ensure date fields are null if empty, otherwise backend might parse "" as error
        ...
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-md space-y-6">
                ...
                <div>
                    ...
                    <select id="bloodTypeId" name="bloodTypeId" value={formData.bloodTypeId} onChange={handleInputChange} disabled={isSubmitting || bloodTypes.length === 0}
