...
const UserManagementTable = ({ users, onRefresh, onSort, currentSortField, currentSortDirection, renderSortIcon }) => {
    ...
    const SortableHeader = ({ field, children }) => (
        <th
            ...
            onClick={() => onSort && onSort(field)} // Gọi onSort khi click
        >
            {children}
            {renderSortIcon && renderSortIcon(field)} {/* Hiển thị icon sort */}
        </th>
    );
